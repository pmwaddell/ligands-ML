...
def lowest_conf_search_from_smiles(smiles: str, CID: str, destination_path: str, num_confs: int=100,
...
def conf_search_xyzs_from_phos_set(phos_set_filename: str, destination_path) -> None:
    ...
    for index, row in phos_set.iterrows():
        ...
        lowest_conf_search_from_smiles(smiles=row["CanonicalSMILES"], CID=row["CID"], destination_path=destination_path)
        print("complete.")


if __name__ == "__main__":
    conf_search_xyzs_from_phos_set(phos_set_filename="data/modified_requests/PO_set_redux.csv",
                                   destination_path="data/conf_search_PO")
